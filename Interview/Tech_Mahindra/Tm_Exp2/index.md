# 💼 Interview Experience – Tech Mahindra (On-Campus Opportunity)
...
The Online Assessment consisted of **3 coding questions**.
...
The technical interview began with a **self-introduction**, followed by a discussion on my **projects**.
...
Even though the final result was not in my favor, the process was a **valuable learning experience**.

---

## 💡 Advice for Others

- Focus strongly on your **projects** — interviewers expect depth.
- Strengthen **core CS subjects**, especially **OS and DBMS**.
- Practice **SQL queries regularly**, as they are frequently asked.
- Do not panic if one round does not go perfectly — stay calm and composed.
