# 💼 Interview Experience – Cisco (Summer SDE Intern)
...
At first, I was genuinely grateful to have **completed and cleared the Online Assessment**.  
Out of all applicants, **only 8 candidates were shortlisted**, and I was thrilled to be one of them.

After the results, we were instructed to prepare a **custom resume** in a very specific format.

---

## 🕶️ Custom Resume Screening (Unique Process)
...
- Deep discussion on:
  ...
  - **Working principles and design decisions**
...
## 🧠 Round 3 – ETR (Executive Technical Round)
...
- Discussion on **preferred work location**
- Short and friendly **Q&A session**
...
- Let your passion speak, it always shows
